...
const stripePromise = loadStripe (
    'pk_test_51Mb1juKwHQqd1BcuiHmKinuzG0Nh25X9rEgaHblKJMBeYC6hVzWehvCsYZhpyHRMc2tUV0BREasGwLnfx3hjMw5i00XUOaF40U'
);
                ...
                >
                    {({
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <Box display='flex' justifyContent='space-between' gap='px'>
                                {!isFirstStep && (
                                    <Button
                                        fullWidth
                                        color='primary'
